...
#fuzz.ratio('Python Package', 'PythonPackage') //96
#process.extractOne('Mississipi', states) //('MISSISSIPPI', 95) state是正确的州名列表,返回的是最相符的一个
#通过这样的方式就可以纠正原数据中拼写错误的地方,为做缩写替换,分组打好基础
